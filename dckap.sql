...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2021 at 07:02 AM
...
INSERT INTO `categories` (`id`, `cat_name`, `cat_status`) VALUES
(1, 'Oil&gas', 'A'),
(2, 'Fisheries', 'A');
...
INSERT INTO `products` (`id`, `category`, `name`, `short_desc`, `description`, `images`, `status`, `created_by`) VALUES
(1, 1, 'oil Filter', 'sadsadasd', 'sadsadsa', '1613099203754sample_1920×1280.jpg,1613099203431sample_1280×853.jpg,1613099203878sample_640×426.jpg', 'A', 1),
(2, 1, 'sdfdsfsdf', 'dsfdsfsdf', 'dsfdsfdsfdsfd', '1613099535465sample_1920×1280.jpg,1613099535280sample_1280×853.jpg,1613099535603sample_640×426.jpg', 'A', 1),
(3, 1, 'ddfdsfdsf', 'dsfdsfds', 'dsfdsfdsfds', '161310646162033367078.jpg', 'A', 1),
(4, 1, 'adasDASD', 'ASDSD', 'SADSDAS SADSClg;lgd ;dlg;dfkdsl;fksdlfkdslfks;ldfk fk;dlsfksd;lfk dkfldfkds;lfksdl; d;fkds;lfkdsl;fk ;fds;fkds;lfkds;lfk ;kfl;dskfd;lsfkd ;dskfds;lfkds;lfkd d;kfds;lfkds;lfkd ;dkfds;lfkds;lf', '1613107535680sample_1920×1280.jpg,1613107535186sample_1280×853.jpg,1613107535105sample_640×426.jpg', 'A', 1),
(5, 2, 'ewrewrewr', 'werewrwe', 'rewrwerwe', '1613108316249sample_1280×853.jpg', 'A', 1);
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `full_name`, `email`, `password`, `city`, `state`, `country`, `address`) VALUES
(1, 'suresh', 'P', 'suresh P', 'suresh@businessgateways.com', '$2y$10$au0qiQZzRtDa9zIeTEDdSO28VPTHDzgOE1ka1wbmwjLfqqlRUJ/fC', 468, 21, 105, 'E Block, Ranganathan Street, Radha Nagar, Chromepet');
